...
urlpatterns = [
    ...
    path('posts/new/', views.post_create_form, name='post_create_form'),
    path('posts/<slug:slug>/edit/', views.post_update_form, name='post_update_form'),
    path('category/new/', views.catagory_create, name='category_create'),
